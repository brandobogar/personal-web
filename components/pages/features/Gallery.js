  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center w-full h-screen bg-my-bg-light text-my-bg-dark dark:bg-my-bg-dark tablet:p-10 phone:px-2">
        <div className="flex flex-col items-center justify-center w-1/2 p-4 phone:p-0 rounded-lg h-max glass phone:w-full phone:m-0 phone:h-max tablet:w-full overflow-hidden mt-10">
          <Splide
            options={mainOptions}
            ref={mainRef}
